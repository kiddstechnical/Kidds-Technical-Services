# Customer and Funder Pathways

## Purpose

Kidd's Technical Services, LLC (KTS) uses practical customer and funder pathways to turn a documented local-information, mapping, preservation, web-support, or ALLIS need into an authorized, funded, and deliverable project.
...
- Get Found Locally setup or cleanup.
- Google Business Profile owner-support assistance.
- Find Us, parking, pickup, directions, or service-area page.
- QR-linked menu, services, booking, ordering, or information hub.
- Delivery-zone, service-area, venue, event, or customer-access map.
- Ongoing listing, map, and public-information updates.
...
### Website, Marketing, Design, and Technology Firms

Website firms, marketing agencies, designers, developers, IT providers, consultants, and related service firms may engage KTS for specialized mapping, location intelligence, GIS data preparation, heritage content, QR tools, or ALLIS-related support.

Typical decision-makers include the firm owner, project manager, account manager, lead developer, or authorized client representative.

KTS may work as a subcontractor, specialist collaborator, white-label contributor, co-branded implementation partner, referral partner, or direct vendor to the shared customer, depending on the written agreement.

Typical services include:

- Interactive maps and website map embedding.
- Service-area, route, delivery-zone, location, and point-of-interest maps.
- GIS data cleanup, address cleanup, geocoding, format conversion, and map-ready data preparation.
- QR-linked map, trail, heritage, visitor, event, and public-information tools.
- Local-information architecture and approved content organization.
- Digital-heritage map features, archive-access tools, and ALLIS support.

Typical payment pathways:

```text
Website or marketing firm includes KTS work in its client proposal
        ↓
...
```text
Website or marketing firm introduces KTS to the client
        ↓
Client contracts directly with KTS for specialized map or information work
        ↓
KTS coordinates with the partner firm under agreed roles and permissions
        ↓
Client pays KTS directly
```
...
- Grant-ready map package.
- Community resource or asset map.
- Event, venue, visitor, trail, parking, or accessibility map.
- QR-linked public-information page.
...
- Collection discovery and preservation assessment.
- Map, record, photograph, and document inventory.
- Metadata, location indexing, map linking, and digital organization.
- Heritage, cemetery, trail, exhibit, visitor, or public-history map.
- QR-linked historic-site or collection-access tool.
- Public web, kiosk, local Wi-Fi, researcher, staff, or offline-capable access planning.
- ALLIS archive-to-access pilot.

Typical payment pathways include:

- Operating budget.
- Donor or membership support.
- Approved preservation, tourism, education, humanities, arts, cultural-resource, or community-development funding.
- Sponsor support.
...
Families, family representatives, cemetery associations, church groups, reunion committees, and local-history organizations may engage KTS directly for genealogy, preservation, organization, mapping, and approved access projects.

Typical decision-makers include a designated family steward, executor or authorized representative where applicable, board officer, church representative, cemetery association representative, or project organizer.

Typical first services include:

- Family-archive discovery and inventory.
- Organization of approved family papers, photographs, maps, records, and oral-history materials.
- Cemetery, church, family, migration, home-place, or reunion map.
- Private archive, shared family collection, QR-linked family-history page, or approved public-history presentation.
- Preservation package, metadata, source organization, and documented handoff.

Typical payment pathways include:

- Direct family payment.
- Pooled family contributions.
- Reunion or association funds.
...
### Municipal, Regional, Tourism, and Public Organizations

Municipalities, counties, regional-development organizations, tourism groups, downtown organizations, trail groups, visitor organizations, and public agencies may engage KTS for defined map, information, preservation, public-access, and digital-service projects.

Typical decision-makers include an authorized official, department head, procurement officer, project manager, grant administrator, board-authorized representative, or other authorized public representative.

Typical first services include:

- Grant-ready map package.
- Public information, visitor, trail, event, parking, resource, or service map.
- Community asset inventory and map organization.
- Heritage, trail, downtown, cemetery, cultural-resource, and visitor-information pilot.
- GIS data cleanup, conversion, organization, and public-access preparation.
- Kiosk, local Wi-Fi, offline-capable, or ALLIS discovery and pilot work.

Typical payment pathways include:

- Operating budget.
- Approved procurement or professional-services contract.
- Authorized public grant or program funds.
...
- A local business pays for a listing cleanup, QR hub, directions page, or service-area map.
- A family pays for a genealogy archive, reunion map, or cemetery-record organization project.
- A website firm pays KTS for subcontracted mapping or data-preparation work.
- A nonprofit pays for a grant-ready map or resource directory from available operating funds.
...
- Founder investment.
- Customer deposits, milestone payments, and paid invoices.
- Retained earnings.
- Commercial loans or lines of credit.
- SBA-backed financing or other eligible business financing.
- Community-development financial institution, bank, lender, or business-support programs where eligible.
- Equipment, software, hosting, or technology financing where appropriate.
- Paid subcontracting revenue from website, marketing, design, technology, preservation, or consulting firms.
- Approved sponsorships, awards, or business-development opportunities for which KTS is eligible.
...
- Independent and authorized approval by the related organization.
- A written scope of work and payment terms.
- A lawful and permitted funding source.
- Reasonable, documented pricing and deliverables.
...
```text
Restaurant owner needs customers to find hours, directions, menu, and pickup details
        ↓
KTS proposes a Get Found Locally and QR Information Hub package
        ↓
Owner approves fixed scope and price
        ↓
Restaurant pays KTS directly
        ↓
KTS delivers corrected public information, QR link, and approved customer-access page
        ↓
Restaurant may add a monthly update plan
```

### Website Firm Collaboration

```text
Website firm is building a client website that needs a reliable local map and service-area display
        ↓
Website firm requests KTS mapping support
        ↓
KTS and firm define scope, branding, customer communication, data access, and payment terms
        ↓
...
```text
Historical society has maps and records that need organization and public access planning
        ↓
Society uses available operating, donor, or project funds for KTS collection discovery
        ↓
KTS completes assessment, inventory, and first-phase preservation/access plan
        ↓
Society may use the plan to seek eligible support for digitization, map access, kiosk, or ALLIS implementation
        ↓
...
```text
Family, church, or cemetery group has scattered records, photographs, and burial-location information
        ↓
...
KTS organizes materials and delivers agreed archive, map, or QR-linked information
        ↓
Steward decides whether any portion will remain private, be shared with family, or be released publicly
```
...
- Approval process and authorized customer contacts.
- Rights, permissions, ownership, licensing, and public-release terms.
...
KTS begins with a simple question:
